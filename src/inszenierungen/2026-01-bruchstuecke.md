...
cast:
  ...
  - role: Müsli
    ...
    scene: when to act
  - role: Ernst
    actor: Flynn Oliver Scott Kaz Maximus Take 
    scene: when to act
  - role: Fussel
    actor: Jan Riebe
    scene: when to act
  ...
  - role: Lachs
    ...
    scene: Ode an den Lachs
  - role: Die Fische
    actor: Anka Charlotte Doese, Jan Riebe, Gabriel 
    scene: Ode an den Lachs
...
crew:
  - role: Technik
    name: Nicolai
  - role: Dramaturgie
    name: Djamilia Lind, Ilea Rahn, Kristina, Nicolai, Sarina Vitillo
...
Drittens: Wir wollten viele kleine Szenen schreiben, damit wir unsere semsterbedingt begrenzte Probezeit gut nutzen können, indem wir parallel an Szenen arbeiten.
Und Viertens: Eine Szenencollage lässt mehr Raum für kreative Ideen und auch die weniger erfahrenen Autor:innen werden zum Schreiben ermutigt.
