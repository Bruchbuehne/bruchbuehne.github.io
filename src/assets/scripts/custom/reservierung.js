...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    function validateReservation() {
        ...
        if ((remaining < 6 || anzahl > remaining) && selectedDate) {
            ...
            infoBox.textContent = `⚠️ Bitte maximal 5 Karten auf einmal reservieren`;
            infoBox.style.color = "red";
            infoBox.style.marginLeft = "1em";
        }
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        if (text.trim() === 'OK') {
            meldung.textContent = '✅ Reservierung erfolgreich! Wir freuen uns auf euren Besuch.';
            form.reset();
        ...
        meldung.style.color = 'red';
        meldung.textContent = '❌ Netzwerkfehler... bitte versuch es später nochmal.';
    }
});